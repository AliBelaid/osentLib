...
const OUTPUT = 'C:\\osentLib\\screen\\dns_lookup.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-dns-' + Date.now();
const PORT = 9229;
...
async function main() {
  ...
  console.log('Navigating to DNS lookup...');
  await ws.call('Page.navigate', { url: 'http://localhost:4100/dns' });
