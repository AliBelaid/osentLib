...
const OUTPUT = 'C:\\osentLib\\screen\\attack_map.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-atk-' + Date.now();
const PORT = 9226;
...
async function main() {
  ...
  console.log('Navigating to attack map...');
  await ws.call('Page.navigate', { url: 'http://localhost:4100/cyber/attack-map' });
  // Give Leaflet map + animations extra time to render
  console.log('Waiting 12s for Leaflet map and animations...');
