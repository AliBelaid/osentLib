...
const OUTPUT = 'C:\\osentLib\\screen\\intelligence-arabic.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-intel-ar-' + Date.now();
const PORT = 9229;
...
async function main() {
  ...
  // Navigate to app and set auth token + Arabic language
  ...
  // Navigate to intelligence page (will use default Arabic)
  console.log('Navigating to intelligence page in Arabic...');
