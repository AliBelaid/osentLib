...
const OUTPUT = 'C:\\osentLib\\screen\\submit-report-page.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-submit-' + Date.now();
const PORT = 9234;
...
async function main() {
  ...
  console.log('Navigating to /submit-report...');
  await ws.call('Page.navigate', { url: 'http://localhost:8088/submit-report' });
  await sleep(5000);
