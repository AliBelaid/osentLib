...
const OUTPUT = 'C:\\osentLib\\screen\\alerts-page.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-alerts-' + Date.now();
const PORT = 9236;
...
async function main() {
  ...
  await ws.call('Page.navigate', { url: 'http://localhost:8088/alerts' });
  await sleep(8000);
