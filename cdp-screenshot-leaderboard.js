...
const OUTPUT = 'C:\\osentLib\\screen\\leaderboard-page.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-leaderboard-' + Date.now();
const PORT = 9237;
...
async function main() {
  ...
  await ws.call('Page.navigate', { url: 'http://localhost:8088/leaderboard' });
  await sleep(8000);
