...
const OUTPUT = 'C:\\osentLib\\screen\\attack-map-page.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-attackmap-' + Date.now();
const PORT = 9235;
...
async function main() {
  ...
  console.log('Navigating to /cyber/attack-map...');
  await ws.call('Page.navigate', { url: 'http://localhost:8088/cyber/attack-map' });
  await sleep(6000);
