...
const OUTPUT = 'C:\\osentLib\\screen\\gis_maps.png';
const TEMP_DIR = process.env.TEMP + '\\cdp-gis-' + Date.now();
const PORT = 9228;
...
async function main() {
  ...
  console.log('Navigating to GIS maps...');
  await ws.call('Page.navigate', { url: 'http://localhost:4100/maps' });
  console.log('Waiting 10s for Leaflet map to render...');
